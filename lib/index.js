...
BeatsAPI.getSearchResults = function (query, search_type, cb) {
  var options = { 'q' : query, 'type' : search_type };
...
BeatsAPI.getAudioAsset = function (track_id) {
